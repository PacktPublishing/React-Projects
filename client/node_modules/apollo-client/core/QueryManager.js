...
var QueryManager = (function () {
                ...
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        return [2, new Promise(function (resolve, reject) {
                                var storeResult;
                                var error;
                                self.getObservableFromLink(mutation, tslib_1.__assign({}, context, { optimisticResponse: optimisticResponse }), variables, false).subscribe({
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        _e.label = 2;
                    case 2:
                        options = tslib_1.__assign({}, options, { variables: variables });
    ...
    QueryManager.prototype.getVariables = function (document, variables) {
        return tslib_1.__assign({}, this.transform(document).defaultVars, variables);
    };
    ...
    QueryManager.prototype.getObservableFromLink = function (query, context, variables, deduplication) {
        ...
        if (serverQuery) {
            ...
            var operation = {
                ...
                context: this.prepareContext(tslib_1.__assign({}, context, { forceFetch: !deduplication })),
            };
    ...
    QueryManager.prototype.startPollingQuery = function (options, queryId, listener) {
        ...
        if (!this.ssrMode) {
            ...
            info.options = tslib_1.__assign({}, options, { fetchPolicy: 'network-only' });
